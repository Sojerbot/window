...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {116251654,227164893,109653427},--Sudo users
    moderation = {data = 'data/moderation.json'},
    about_text = [[===============================

id channel :=: @Channel_window

===============================

sudo user :=: @SUDO_window + @KiNG_AlONE_DARKNESs + @Rocky_balboa1 

===============================

id bot payamresan :=: @window_report_BOT

===============================

bot id :=: https://telegram.me/MEGA_WINDOW
